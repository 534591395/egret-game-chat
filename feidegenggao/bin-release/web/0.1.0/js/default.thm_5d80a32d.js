	...
	function Pannel() {
		_super.call(this);
		this.skinParts = ["bg","cloudBox","cloudBottomBg","personBox","countDownBar","countTimeLeft","countTimeRight","numberDistanceOne","numberDistanceTwo","numberDistanceThree","numberDistanceFour","scoreProgressBar","numberScoreOne","numberScoreTwo","numberScoreThree"];
		
		this.height = 480;
		this.width = 320;
		this.elementsContent = [this.bg_i(),this._Image1_i(),this._Image2_i(),this.cloudBox_i(),this.cloudBottomBg_i(),this.personBox_i(),this._Group2_i(),this._Group3_i(),this._Group4_i()];
	}
